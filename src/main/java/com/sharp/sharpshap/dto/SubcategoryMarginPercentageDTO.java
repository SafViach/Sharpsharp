...
@AllArgsConstructor
@NoArgsConstructor
public class SubcategoryMarginPercentageDTO {
    //marginPercentage коэффициент надбавки маржи на товары по данной подкатегории
    //Изменение доступны для всех
    @NotNull(message = "Введи коэффициент надбавки маржи на " +
            "товары по данной подкатегории от 1.1 до 20.0")
